      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-4 py-2 rounded-md disabled:bg-gray-400 w-full bg-red-500 text-white font-medium hover:bg-red-600"
          >
        ...
        {rateId && (
          <div className="mt-8">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-2  rounded-md bg-red-500 text-white font-medium hover:bg-red-600 disabled:bg-gray-400"
            >
        ...
        {trackingObj && (
          <div className="mt-8">
            ...
            <Link href="/place-order">
              <button className="px-4 py-2 w-full rounded-md my-3 bg-red-500 text-white font-medium hover:bg-red-600 ">place order</button>
            </Link>
          </div>
        )}
        {errors.length > 0 && (
...
export default CodShippingRatesPage;